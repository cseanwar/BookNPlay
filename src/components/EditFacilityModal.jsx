...
export function EditFacilityModal({ facility }) {
  ...
  return (
    <Modal>
      {/* <button className="flex-1 h-12 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-emerald-500 transition-all duration-300 font-semibold flex items-center justify-center gap-2 text-gray-700">
        <Pencil size={18} />
        Edit
      </button> */}
      <Button
